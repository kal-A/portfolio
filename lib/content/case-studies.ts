...
const caseStudiesData: CaseStudy[] = [
  ...
  },
  {
    ...
    oneLiner: "Built a mentorship platform solo, then used analytics and session recordings to decide what to fix next.",
    summary:
      "Designed and built PathPeer's mentorship platform solo, then used Google Analytics and Hotjar recordings to find where users were getting stuck, turned those patterns into prioritized feature plans, and validated smaller changes with no-code tooling before requesting development time.",
    tags: ["Product Management", "UX Research", "Behavioural Analytics"],
    toolTags: ["Google Analytics", "Hotjar", "Figma", "n8n"],
    artifacts: [],
    metrics: [
    ...
    problem:
      "PathPeer's mentorship platform was live, which meant the open question was no longer whether people were using it, but where they were getting stuck and what to fix first. As the platform's solo designer and developer, I owned that loop end to end.",
    process: [
      "Built and launched the mentorship platform end-to-end, handling design and development solo.",
      "Used Google Analytics to find where engagement dropped across the platform, then reviewed the matching Hotjar recordings to see what was actually happening at each point.",
      "Turned the strongest patterns into scoped feature and requirement plans, and validated smaller changes with no-code tooling (n8n) before requesting further development time.",
      "Iterated on the design based on that evidence rather than assumptions.",
    ],
    outcome: [
      "Increased user engagement by 50% through iterative changes driven by the analytics and session-recording loop.",
      "Reduced inactive user drop-off by 40%.",
    ],
    note: "This case study reconstructs the analysis workflow I used during the internship; the platform's internal analytics dashboards and session recordings are not shown for confidentiality.",
  },
  {
    slug: "informatica",
    category: "systems",

            ...
            <Reveal className="flex-1 min-w-0">
              ...
              <div className="flex flex-wrap gap-2.5 mt-5">
                {cs.metrics.slice(0, 2).map((m) => (
                  ...
                  >
                    <span className="font-serif text-base font-bold" style={{ color: "var(--cs-accent-deep)" }}>
                      {m.value}
                    </span>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {cs.tags.map((tag) => (
                      <span
                        ...
                        style={{ background: GOLD_GRADIENT, color: "#fff9ee", borderColor: "var(--ink)" }}
                      >
                        {tag}
                      </span>
                    ))}
      ...
      <div id="s1" className="cs-seam" style={{ background: TONE_CREAM }}>
        <div className="mx-auto max-w-5xl px-6 py-24">
          ...
          <Reveal>
            ...
            <ProcessFlow steps={CURRENT_PROCESS_STEPS} accent="#c9941a" topAlignRows />
          </Reveal>
        </div>
      </div>

            ...
            <Reveal className="flex-1 min-w-0">
              ...
              <div className="flex flex-wrap gap-2.5 mt-5">
                {cs.metrics.slice(0, 2).map((m) => (
                  ...
                  >
                    <span className="font-serif text-base font-bold" style={{ color: "#a12f2f" }}>
                      {m.value}
                    </span>
            ...
            <Reveal delay={150} className="mt-10 md:mt-24 w-full md:w-[300px] shrink-0">
              <nav className="cs-box white quiet-hover px-6 py-7" style={{ background: "#fffdf8" }}>
                ...
                <div className="mt-6 pt-5" style={{ borderTop: "1.5px dashed rgba(32,28,23,0.16)" }}>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {cs.tags.map((tag) => (
                      <span
                        ...
                        style={{ background: RED_GRADIENT, color: "#fff9ee", borderColor: "var(--ink)" }}
                      >
                        {tag}
                      </span>
                    ))}
                  ...
                  <div className="flex flex-wrap gap-2">
                    {["Trello", "Microsoft Planner", "Microsoft Loop", "Java"].map((chip) => (

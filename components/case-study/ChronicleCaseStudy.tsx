            ...
            <Reveal className="flex-1 min-w-0">
              ...
              <div className="flex flex-wrap gap-2.5 mt-5">
                {[
                  ...
                  { value: "500+", label: "backend and frontend automated tests passing" },
                ].map((m) => (
                  <span
                    key={m.label}
                    className="cs-pill inline-flex items-baseline gap-1.5 text-xs font-bold px-3.5 py-1.5"
                  >
                    <span className="font-serif text-base font-bold" style={{ color: "#2e4a6b" }}>
                      {m.value}
                    </span>
              ...
              <nav className="cs-box white px-6 py-7" style={{ background: "#fffdf8" }}>
                ...
                <div className="mt-6 pt-5" style={{ borderTop: "1.5px dashed rgba(32,28,23,0.16)" }}>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {["AI Systems", "Agent Architecture", "Product Architecture"].map((tag) => (
                      <span
                        key={tag}
                        className="cs-pill inline-flex items-center text-[10.5px] font-extrabold uppercase tracking-wide px-3 py-1.5 cursor-default"
                        style={{ background: INK_GRADIENT, color: "#fff9ee", borderColor: "var(--ink)" }}
                      >
                        {tag}
                      </span>
                    ))}
                  ...
                  <div className="flex flex-wrap gap-2">
                    {["Python", "Pydantic", "TypeScript", "React", "Ollama"].map((chip) => (
